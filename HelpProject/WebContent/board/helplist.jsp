...
<body>
	<div id="wrap">
		...
		<br>
		<div id="board">
			<table id="bList" width="800" border="1" bordercolor="black">
				<tr height="30">
 ...
 -->
		...
		<div id="searchForm">
			<form action="search.mvc">
				<input type="radio" name="gender" value="무관" checked="checked">무관
				...
				<br>
				단어로 검색 <input type="text" size="20" name="condition"/>&nbsp; 
...
<meta charset="UTF-8">
<title>Insert title here</title>
<script src="jquery-3.2.1.min.js"></scrpit>
<script>
$(document).ready(function(){
});
</script>
		...
		<div id="searchForm">
			<form>
				<select name="opt">
					...
					<option value="3">시/도</option>
					<option value="4">시/군</option>
